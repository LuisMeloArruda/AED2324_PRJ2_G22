 ...
 * Graph.h
 */
#ifndef AED2324_PRJ2_G22_GRAPH_H
#define AED2324_PRJ2_G22_GRAPH_H
...
template <class T>
        /**
         * @brief the vertex/node of a graph, represents the object
         * @tparam T
         */
class Vertex {
    T info;                // contents
...
template <class T>
        /**
         * @brief The edge of a graph, links the objects
         * @tparam T
         */
class Edge {
...
template<class T>
void Vertex<T>::setInDegree(unsigned int degree) {
    Vertex::inDegree = degree;
}
...
/**
 * @brief Adds an edge to a graph (this), given source and destination vertices and the edge weight (w).
 * @returns True if successful, and false if the source or destination vertex does not exist.
 */
template <class T>
bool Graph<T>::addEdge(Vertex<T>* sourc, Vertex<T>* dest, string airline) {
...
#endif //AED2324_PRJ2_G22_GRAPH_H
